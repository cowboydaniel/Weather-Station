...
<title>Gas</title>
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect x='6' y='6' width='52' height='52' rx='14' fill='%23ffd278'/%3E%3Cpath d='M24 42c0-10 6-16 8-24 2 8 8 14 8 24a8 8 0 1 1-16 0z' fill='white'/%3E%3C/svg%3E">
<style>
...
body{margin:0;color:var(--text);font-family:system-ui;background:radial-gradient(1200px 700px at 50% 10%, rgba(255,210,120,0.14), transparent 60%),var(--bg);min-height:100vh}
...
function draw(series){
  ...
  now.textContent = series[series.length-1].toFixed(1) + " kΩ";
  minv.textContent = Math.min(...data).toFixed(1) + " kΩ";
  maxv.textContent = Math.max(...data).toFixed(1) + " kΩ";
}
