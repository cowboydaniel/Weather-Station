...
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect x='6' y='6' width='52' height='52' rx='14' fill='%237aa7ff'/%3E%3Cpath d='M32 14v24' stroke='white' stroke-width='5' stroke-linecap='round'/%3E%3Ccircle cx='32' cy='44' r='9' fill='white'/%3E%3C/svg%3E">
<style>
...
body{margin:0;color:var(--text);font-family:system-ui;background:radial-gradient(1200px 700px at 15% 10%, rgba(110,160,255,0.22), transparent 60%),var(--bg);min-height:100vh}
...
function draw(series){
  ...
  now.textContent = series[series.length-1].toFixed(1) + " °C";
  minv.textContent = mn.toFixed(1) + " °C";
  maxv.textContent = mx.toFixed(1) + " °C";
}
