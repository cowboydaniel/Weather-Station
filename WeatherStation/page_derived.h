...
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Cdefs%3E%3CradialGradient id='g' cx='30%25' cy='30%25' r='80%25'%3E%3Cstop offset='0%25' stop-color='%23ffe0b8'/%3E%3Cstop offset='45%25' stop-color='%23ffb347'/%3E%3Cstop offset='100%25' stop-color='%23ff8c00'/%3E%3C/radialGradient%3E%3C/defs%3E%3Crect x='6' y='6' width='52' height='52' rx='14' fill='url(%23g)'/%3E%3Cpath d='M20 44V28l12-8 12 8v16' fill='none' stroke='white' stroke-width='3' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M28 44v-8h8v8' fill='none' stroke='white' stroke-width='3'/%3E%3Ccircle cx='44' cy='20' r='6' fill='white' opacity='0.9'/%3E%3C/svg%3E">
...
body{
  ...
  color:var(--text);
  background:
    radial-gradient(1200px 700px at 20% 10%, rgba(255,180,100,0.18), transparent 60%),
    radial-gradient(900px 600px at 80% 25%, rgba(255,140,0,0.14), transparent 55%),
    radial-gradient(800px 800px at 60% 115%, rgba(110,160,255,0.10), transparent 60%),
    var(--bg);
  min-height:100vh;
}
...
@media (max-width:760px){ .card{ grid-column:span 12; } .top{ flex-direction:column; align-items:flex-start; } }
</style>
</head>
